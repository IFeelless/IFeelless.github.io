 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <ul class="navbar-nav">
   ...
   <ul class="navbar-nav ml-auto">
	   <li><router-link :to="{name:'loginLink'}" class="navbar-link">登录</router-link></li>
	   <li><router-link :to="{name:'registerLink'}" class="navbar-link">注册</router-link></li>
   </ul>
